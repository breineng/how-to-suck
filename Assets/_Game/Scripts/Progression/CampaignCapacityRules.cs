...
namespace HowToSuck
{
    ...
    public static class CampaignCapacityRules
    {
        ...
        private static readonly long[] Prices = {150,250,400,650,1000,1500,2200,3200};
        public static bool TryModel(string tier,out int basis,out int maximum)
        {
            switch(tier){case "mk1":basis=1;maximum=5;return true;case "mk2":basis=3;maximum=8;return true;
                case "mk3":basis=5;maximum=12;return true;case "mk4":basis=8;maximum=16;return true;default:basis=maximum=0;return false;}
        }
        ...
        public static bool TryNext(string tier,int purchasedExtraSlots,out int current,out int next,out long price)
        {
            ...
            next=Effective(tier,purchasedExtraSlots+1);if(next<=current)return false;price=Prices[purchasedExtraSlots];return true;
        }
    }
}
